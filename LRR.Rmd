...
Site.Name <- c("HW", "HW", "HW", "PM", "PM", "PM", "PM", "SD", "SD", "SD", "SD")
Metric.Groups <- c("Vegetation Cover", "Vegetation Sp. Diversity", "Invertebrates", "Vegetation Sp. Diversity", "Invertebrates", "Fish", "Birds", "Vegetation Cover", "Fish", "Birds", "Invertebrates")
Metric.Groups.ABBR <- c("VC", "VSD", "I", "VSD", "I", "F", "B", "VC", "F", "B", "I")
Avg.LRR <- c(-0.01373019, -0.01047130, -0.9453782, 1.0986123, 0.4795731, 0.3364722, 0.1965213, -0.06371581, 0.1040744, 0.4054651, -0.05491632)
SD.LRR <- c(NA, NA, 0.9827355, NA, NA, 0.2379218, 0.1289208, NA, 0.2198847, 1.241267, 0.4657671)
AVGRefLRR <- data.frame(Site.Name, Metric.Groups, Metric.Groups.ABBR, Avg.LRR, SD.LRR)
view(AVGRefLRR)
```
